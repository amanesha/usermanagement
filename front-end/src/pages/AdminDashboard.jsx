...
import { Users, UserCheck, UserX, Clock, Briefcase, TrendingUp, ArrowUpRight, Plus } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white shadow-xl">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-lg">Welcome back! Manage your team and view analytics.</p>
          </div>
          <Link
            to="/admin/users/add"
            className="flex items-center gap-2 px-6 py-3 bg-white text-blue-600 rounded-xl font-medium hover:bg-blue-50 transition-colors shadow-lg hover:shadow-xl"
          >
            <Plus size={20} />
            Add User
          </Link>
